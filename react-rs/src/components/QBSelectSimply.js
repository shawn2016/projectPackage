  ...
  render() {
    ...
    return (
      <div className="">
        ...
        <div className={this.props.inputClass} style={{ width: '100px', padding: '0' }}>
            ...
            <div className={`rob-select ${this.state.showOptions ? 'open' : ''} ${this.state.isError ? 'rob-input-has-error' : ''}`}>
              <div className="rob-has-icon-right" data-toggle="dropdown" aria-expanded="true">
                <div
                  ...
                  title={this.props.type === 'default' ? this.props.placeholder : ''}
                >
                  <i className="rob-is-icon-right qb-icon-angle-down" />
                  {this.props.type === 'default' ? this.props.placeholder : <input
                    type="text"
                    className="rob-input"
                    id="inputEmail3"
                    placeholder="请输入选项"
