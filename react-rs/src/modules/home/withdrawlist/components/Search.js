...
export default connect(WDWL_loanProgressQuery => ({
  data: WDWL_loanProgressQuery
}), dispatch => ({
  getData: bindActionCreators(action.WDWL_getData, dispatch),
  getAccountData: bindActionCreators(action.WDWL_getAccountData, dispatch),
  resetCurrentPage: bindActionCreators(action.WDWL_reserCurrentPage, dispatch)
}))(Search)