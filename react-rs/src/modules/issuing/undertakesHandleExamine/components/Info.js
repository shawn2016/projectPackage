...
class Info extends PureComponent {
  ...
  _goToDetailsPage = item => {
    this.props.history.push({
      pathname: '/issuing/undertakesExamineDetails',
      state: { data: item, from: 'undertakesHandleExamine', source: 2 }
    })
  }
  // checkbox选择
  checkedFunc = (node) => {
...
export default connect(state => ({
  isSearch: state.undertakesHandleExamineInfo && state.undertakesHandleExamineInfo.isSearch,
  queryInfo: state.undertakesHandleExamineInfo && state.undertakesHandleExamineInfo.queryInfo,
  orderList: state.undertakesHandleExamineInfo && state.undertakesHandleExamineInfo.orderList,
  pageInfo: state.undertakesHandleExamineInfo && state.undertakesHandleExamineInfo.pageInfo,
  examineResult: state.undertakesHandleExamineInfo && state.undertakesHandleExamineInfo.examineResult
}), dispatch => ({
  isSearchFunc: bindActionCreators(actions.isUndertakesExamineSearch, dispatch),
