...
export default connect(state => ({
  ...
  companyAccList: state.undertakesHandleCancelInfo && state.undertakesHandleCancelInfo.companyAccList,
}), dispatch => ({
  updateSearchInfo: bindActionCreators(actions.updateUndertakesCancelSearchInfo, dispatch),
  getCompanyAccList: bindActionCreators(actions.getUndertakesCancelCompanyAccList, dispatch),
