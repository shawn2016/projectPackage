...
class Content extends PureComponent {
  ...
  attachConfig = () => {
    ...
    return {
      action: config.file('/payment/agency/importInfo'),
              ...
              this.props.getPurposeList().then((res) => {
                ...
                this.setState({ purpose: '', showAddPurpose: false, isTestRule: true }, () => {
                  !this.payerId.getErrStatus() &&
                    (this.state.companyType === '100' ? !this.refBizRule.getErrStatus() : true) &&
  ...
  checkFailure = () => {
    if (this.state.attachments.successCount === 0) {
      ...
      this.props.history.push({
        pathname: '/issuing/undertakesDetailPerson',
  ...
  alertClose = (type) => {
    ...
    if (type === 'saveOrder') this.props.history.push('/issuing/undertakesHandleSearch')
    if (type === 'checkMoney') {
      this.checkFailure()
    }
  ...
  /* 下载excel模块 */
  downloadExcel = () => {
    window.open(config.downloadExcel('issuing'))
  }
  /* format alert Info */
  formatAlertInfo = (text, type) => {
    this.setState({
    ...
    return (
      <div>
        <div className="rob-form-group">
          ...
          {this.state.showAddPurpose ? <div className="rob-form-group-has-button rob-col-lg-offset-6 rob-col-lg-12 rob-col-md-offset-6 rob-col-md-12">
            <div className="rob-col-lg-6 rob-col-md-6 rob-col-sm-24 rob-col-xs-24 ">
              <label htmlFor="inputEmail3" className="rob-input-label " />
            </div>
            <QBInput
            ...
            >
              <button className="rob-btn rob-btn-danger rob-btn-circle" style={{ opacity: '1' }} type="button">增加</button>
            </span>
          </div> : ''}
          ...
          {this.state.uploadFileSucc ? <div>
            ...
            <div className="rob-form-group-has-button rob-col-lg-offset-6 rob-col-lg-12 rob-col-md-offset-6 rob-col-md-12">
              ...
              {this.state.attachments.successCount > 0 ? <span
                ...
                style={{ right: '-55px' }}
                onClick={() => {
                  sessionStorage.setItem('excelDetailState', JSON.stringify({ serialNo: this.props.orderInfo.serialNo, type: 10, model: 'agency' }))
            ...
            <div className="rob-form-group-has-button rob-col-lg-offset-6 rob-col-lg-12 rob-col-md-offset-6 rob-col-md-12">
              ...
              {this.state.attachments.failureCount > 0 ? <span
                ...
                style={{ right: '-55px' }}
                onClick={() => {
                  sessionStorage.setItem('excelDetailState', JSON.stringify({ serialNo: this.props.orderInfo.serialNo, type: 20, model: 'agency' }))
                  window.open('/otherInfo/batchDetailList')
                }}
              >
                <button className="rob-btn rob-btn-danger rob-btn-circle" style={{ opacity: '1' }} type="button">查看明细</button>
          ...
          <div className="qb-form-footButton-g clearfix " style={{ marginBottom: '-20px' }}>
            <div className=" rob-col-lg-offset-6 rob-col-lg-12 rob-col-md-offset-6 rob-col-md-12">
              ...
              {this.state.companyType === '200' ? <button
                className="rob-btn rob-btn-danger rob-btn-circle"
                type="button"
                onClick={this.goToUndertakesDetail}
              >
                下一步
              </button> : null}
            </div>
...
export default connect(state => ({
  payerlist: state.UndertakesOrgnaizationInfo && state.UndertakesOrgnaizationInfo.payerlist,
  orderInfo: state.UndertakesOrgnaizationInfo && state.UndertakesOrgnaizationInfo.orderInfo,
  bizRuleList: state.UndertakesOrgnaizationInfo && state.UndertakesOrgnaizationInfo.bizRuleList,
  purPoseList: state.UndertakesOrgnaizationInfo && state.UndertakesOrgnaizationInfo.purPoseList
}), dispatch => ({
  getPayerList: bindActionCreators(actions.getUndertakesOrgPayerList, dispatch),
  updateOrderInfo: bindActionCreators(actions.updateUndertakesOrgOrderInfo, dispatch),
  getBizRuleType: bindActionCreators(actions.getUndertakesOrgBizRuleType, dispatch),
  getPurposeList: bindActionCreators(actions.getUndertakesOrgPurposeList, dispatch)
}))(Content)
