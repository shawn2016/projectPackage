...
export default connect(state => ({
  ...
  companyAccList: state.GSSBH_singleHandleSearchInfo && state.GSSBH_singleHandleSearchInfo.GSSBH_companyAccList,
  statusList: state.GSSBH_singleHandleSearchInfo && state.GSSBH_singleHandleSearchInfo.GSSBH_statusList
}), dispatch => ({
  updateSearchInfo: bindActionCreators(actions.GSSBH_updateSearchInfo, dispatch),
  getCompanyAccList: bindActionCreators(actions.GSSBH_getCompanyAccList, dispatch),
  getStatusList: bindActionCreators(actions.GSSBH_getStatusList, dispatch),
  getOrderList: bindActionCreators(actions.GSSBH_getOrderList, dispatch),
  resetCurrentPage: bindActionCreators(actions.GSSBH_resetCurrentPage, dispatch),
}))(Search)