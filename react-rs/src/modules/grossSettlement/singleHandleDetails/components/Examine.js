    ...
    this.setState({ isShowErrorWindow: false }, () => {
      if (this.state.respCode === '000000') {
        this.props.history.push({
          pathname: '/grossSettlement/examineSingleHandle',
        })
      }
    })
  }
...
Examine.propTypes = {
  ...
  saveExamineSesult: PropTypes.func.isRequired,
...
export default connect(state => ({
  orderInfo: state.GSSHD_singleHandleDetails && state.GSSHD_singleHandleDetails.GSSHD_examineResult
}), dispatch => ({
  saveExamineSesult: bindActionCreators(actions.GSSHD_saveExamineSesult, dispatch)
}))(Examine)