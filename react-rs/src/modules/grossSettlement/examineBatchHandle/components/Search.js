...
export default connect(state => ({
  ...
  companyAccList: state.batchHandleExamineInfo && state.batchHandleExamineInfo.companyAccList,
}), dispatch => ({
  isSearch: bindActionCreators(actions.isBatchExamineSearch, dispatch),
  updateSearchInfo: bindActionCreators(actions.updateBatchExamineSearchInfo, dispatch),
  getCompanyAccList: bindActionCreators(actions.getBatchExamineCompanyAccList, dispatch),
