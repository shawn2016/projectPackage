  ...
  render() {
    ...
    return (
      <div className="rob-row">
        ...
        {this.props.params.from === 'searchBatchHandle' ? <div>
          <div className="rob-col-lg-12 rob-col-md-12 rob-col-sm-24  rob-col-xs-24">
            <div className="rob-col-lg-8 rob-col-md-7 rob-col-sm-7  rob-col-xs-7 qb-no-padding-rg">
          ...
          <div className="rob-col-lg-12 rob-col-md-12 rob-col-sm-24  rob-col-xs-24">
            ...
            <div className="rob-col-lg-16 rob-col-md-17 rob-col-sm-17  rob-col-xs-17">
              <label className="qb-listdesc-g__content__desc">
                {orderInfo.successAmount ? formatMoneyYuan(orderInfo.successAmount) : null}
              </label>
            </div>
          </div>
          <div className="rob-col-lg-12 rob-col-md-12 rob-col-sm-24  rob-col-xs-24">
          ...
          <div className="rob-col-lg-12 rob-col-md-12 rob-col-sm-24  rob-col-xs-24">
            ...
            <div className="rob-col-lg-16 rob-col-md-17 rob-col-sm-17  rob-col-xs-17">
              <label className="qb-listdesc-g__content__desc">
                {orderInfo.failureAmount ? formatMoneyYuan(orderInfo.failureAmount) : null}
              </label>
            </div>
          </div>
        </div> : null}
...
export default connect(state => ({
  orderInfo: state.GSBHD_singleHandleDetails && state.GSBHD_singleHandleDetails.GSBHD_orderInfo
}))(BusinessInfo)