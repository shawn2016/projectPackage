...
class BatchDetailPerson extends PureComponent {
  constructor(props) {
    super(props)
    this.state = {
      dataList: {}
...
BatchDetailPerson.propTypes = {
  params: PropTypes.object,
  history: PropTypes.object
}
BatchDetailPerson.defaultProps = {
  params: {},
  history: {}
}
export default BatchDetailPerson